...
if __name__=='__main__':
    ...
    while(1):
        if(key0.value() == 0):
            ...
            LCD.fill_rect(60,100,128,8,LCD.white)
            LCD.text("Cut the shit",60,100,LCD.red)
        else :
        ...
        if(key1.value() == 0):
            ...
            LCD.fill_rect(60,100,128,8,LCD.white)
            LCD.text("no more key1 plz",60,100,LCD.blue)
        else :
        ...
        if(key2.value() == 0):
            ...
            LCD.fill_rect(60,100,128,8,LCD.white)
            LCD.text("Are you on dope?",60,100,LCD.green)
        else :
        ...
        if(key3.value() == 0):
            ...
            LCD.fill_rect(60,100,128,8,LCD.white)
            LCD.text("Your fly is open",60,100,LCD.black)
        else :
